...
const Welcome = () => {
  ...
  return (
    <div className="h-[calc(100vh-81px)] w-full flex items-center justify-center bg-linear-to-br from-indigo-50 to-purple-100 dark:from-slate-900 dark:to-slate-800 overflow-hidden">
